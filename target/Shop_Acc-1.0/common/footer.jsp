<%-- 
    Document   : footer
    Created on : Feb 23, 2025, 4:31:57 PM
    Author     : MSI2022
--%>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div>
                    <a href="#" class="text-white me-2"><i class="fa-brands fa-facebook">FB</i></a>
                    <a href="#" class="text-white me-2"><i class="fa-brands fa-youtube">Y</i></a>
                    <a href="#" class="text-white"><i class="fa-brands fa-discord">D</i></a>
                </div>
            </div>
        </div>
