            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-muted">Finance</h1>
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            ...
                                            <div class="h5 mb-0 text-gray-800" id="CurrentMonth">$thêm số lượng ở đây</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="far fa-money-bill-alt fa-2x text-gray-400"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            ...
                                            <div class="h5 mb-0 text-gray-800" id="Previous">$thêm số lượng ở đây</div>
                                        </div>

                                        <div class="col-auto">
                                            <i class="fas fa-money-bill-wave fa-2x text-gray-400"></i> <!-- Đổi text-gray-300 thành text-gray-400 -->
                                        </div>
                                    </div>
                                </div>
                            </div>
