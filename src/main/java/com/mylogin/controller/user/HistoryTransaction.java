 ...
 * @author hieup
 */
@WebServlet(name="HistoryTransaction", urlPatterns={"/user/historytrans"})
public class HistoryTransaction extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<LogsRef> logs = null;
        try {
            logs = historyDAO.getLogRefsByUserId(users.getUserId());
       ...
       request.getRequestDispatcher("/views/user/lsgiaodich.jsp").forward(request, response);
    } 
