 ...
 * @author hieup
 */
@WebServlet(name="WaitingControl", urlPatterns={"/waiting"})
public class WaitingControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet WaitingControl</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet WaitingControl at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (session != null && session.getAttribute("account") != null) {
            ...
            // Tạo một Map ánh xạ roleId với đường dẫn tương ứng
